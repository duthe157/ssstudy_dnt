  ...
  return (
    <AccordionPrimitive.Header className="flex">
      <AccordionPrimitive.Trigger
        ...
        className={cn(
          "focus-visible:border-ring focus-visible:ring-ring/50 flex flex-1 items-center",
      ...
      >
        ...
        <ChevronDownIcon
          className={cn(
            "text-blue-500 pointer-events-none size-5 shrink-0 transition-transform duration-200",
            iconClassName
          )}
        />
      </AccordionPrimitive.Trigger>
