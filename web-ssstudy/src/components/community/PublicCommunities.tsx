  ...
  return (
    <section className="container mx-auto">
      <div className="flex items-center">
        ...
        <div className="w-full h-full flex-1 relative mb-8">
          <input
            type="text"
            placeholder="Tìm kiếm cộng đồng"
            className="w-full pl-4 pr-10 py-2 rounded-full border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 text-gray-700"
          />
