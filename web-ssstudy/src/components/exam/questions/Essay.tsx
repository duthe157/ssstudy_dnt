...
const Essay: React.FC<EssayProps> = ({
  ...
  const maxLength = 1000; // Giới hạn độ dài tối đa
    ...
    <div className="w-full rounded-lg border border-gray-200 bg-white p-6">
      ...
      <div className="flex justify-center">
        <textarea
          ...
          disabled={isTimeEnd}
          maxLength={maxLength}
          className={`h-32 w-full max-w-2xl rounded-lg border p-3 focus:ring-2 disabled:cursor-not-allowed ${
...
export default React.memo(Essay, (prevProps, nextProps) => {
  return (
