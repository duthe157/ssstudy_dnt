  ...
  const onSubmit = async (data: SignUpFormData) => {
    ...
    try {
      ...
      if (response.code === 200) {
        ...
        // Nếu backend trả token ngay trong signUp, dùng luôn
        ...
        if (signupToken) {
          ...
          if (signupUser) {
            localStorage.setItem(
              ...
              JSON.stringify({
                ...
                user_group: signupUser.user_group,
              })
            );
          }
          try {
          ...
          // Fallback: gọi signIn bằng thông tin vừa đăng ký
          ...
          if (loginRes.code === 200 && loginRes.data?.token) {
            ...
            localStorage.setItem(
              ...
              JSON.stringify({
                ...
                user_group: loginRes.data.user_group,
              })
            );
            try {
              window.dispatchEvent(new Event("storage"));
