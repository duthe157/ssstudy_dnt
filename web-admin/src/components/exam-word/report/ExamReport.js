...
import { listClass, reportClass2, ShowExam } from "../../../redux/exam/action";
...
class ExamV2Report extends Component {
  constructor(props) {
    super();
    this.state = {
      classroom_id: "",
  ...
  onChange = async (e) => {
    ...
    await this.props.reportClass2(data);
    ...
    if (
      ...
      for (let i = 0; i < this.props.reportData.testings.length; i++) {
        ...
        const _userExam = {
          ...
          Diem: this.props.reportData.testings[i].total_score_achieve,
  ...
  fetchParams = () => {
    if (
      ...
      return this.props.reportData.testing_questions.sort((a, b) => a.question_no - b.question_no).map((obj, i) => {
        var { total_right, total_wrong, question_code, question_no } = obj;
        var total =
        ...
        return (
          <div className="widget-result-item d-flex flex-row justify-content-start align-items-center">
            <div className="widget-result-item-left">
              Câu {question_no}: <b>{question_code}</b>
            </div>
        ...
        series: [
          {
            ...
            data: [
              {
                name: this.props.reportData.PR4.name,
                y: this.props.reportData.PR4.value,
                color: "#0088FE",
              },
              {
                name: this.props.reportData.PR3.name,
                y: this.props.reportData.PR3.value,
                color: "#00C49F",
              },
              {
                name: this.props.reportData.PR2.name,
                y: this.props.reportData.PR2.value,
                color: "#FFBB28",
              },
              {
                name: this.props.reportData.PR1.name,
                y: this.props.reportData.PR1.value,
                color: "#FF8042",
              },
              {
                name: this.props.reportData.PR0.name,
                sliced: true,
                selected: true,
                y: this.props.reportData.PR0.value,
                color: "lightgray",
              },
            ],
          },
...
function mapDispatchToProps(dispatch) {
  return bindActionCreators({ listClass, reportClass2, ShowExam }, dispatch);
}

export default withRouter(
  connect(mapStateToProps, mapDispatchToProps)(ExamV2Report)
);
