...
import { DatePicker, Select, Radio, notification } from "antd";
...
class ModalAddLesson extends Component {
    constructor(props) {
        if (props.classroom)
            console.log(props)
        super();
    ...
    handleSubmit = async () => {
        ...
        if (this.props.redirect_cate === true) {
    ...
    onFocusDate = () => {
        ...
        if (this.state.satusOpenDate === false) {
            document.getElementById('modal-add-lesson').style.overflowY = 'hidden'
            this.setState({
                satusOpenDate: true
            })
        } else {
            document.getElementById('modal-add-lesson').style.overflowY = 'auto'
            this.setState({
                satusOpenDate: false
            })
        }
                            ...
                            >
                                ...
                                <td className='text-right'>
                                    <div className="item-action">
                                        ...
                                        <a href="#!" onClick={() => this.handleRemoveLesson(this.props.index)}>
                                                        ...
                                                        <div className="form-group mb-4" style={{ width: '30%', marginRight: '24px' }}>
                                                            ...
                                                            <div className="group-date">
                                                                <DatePicker
                                                                    ...
                                                                    onChange={(date) => this.setState({ timeLivestream: date.format("YYYY/MM/DD HH:mm") })}
...
function mapDispatchToProps(dispatch) {
    return bindActionCreators(
        {
            listSubject, createChapter, createCategory, uploadImage, listExam, listChapter
        },
        dispatch
    );
}
...
export default withRouter(
    connect(mapStateToProps, mapDispatchToProps)(ModalAddLesson)
);
