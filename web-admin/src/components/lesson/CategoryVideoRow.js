                        ...
                        <div className="category-delete">
                            <span className="ordering">
                                <span className="updatePos" onClick={(e) => this.handlePositionSubmit(e, 'CATEGORY', object, 'up')}>
                                    <svg viewBox="0 0 24 24" width="24" height="24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round" className="css-i6dzq1"><polyline points="18 15 12 9 6 15"></polyline></svg>
                                </span>
                                <span className="updatePos" onClick={(e) => this.handlePositionSubmit(e, 'CATEGORY', object, 'down')}>
                                    <svg viewBox="0 0 24 24" width="24" height="24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round" className="css-i6dzq1"><polyline points="6 9 12 15 18 9"></polyline></svg>
                                </span>
                            </span>
