...
const reducer = (state = initState, action) => {
    switch (action.type) {
        case ActionTypes.LIST_EXAM_WORD_TEST_CATEGORY:
            return {
                ...state,
        ...
        case ActionTypes.EXAM_WORD_TEST_CATEGORY_PAGING:
            return {
                ...state,
                page: action.page,
            };
        case ActionTypes.CREATE_EXAM_WORD_TEST_CATEGORY:
            return {
                ...state,
            };
        case ActionTypes.SHOW_EXAM_WORD_TEST_CATEGORY:
            return {
                ...state,
                examCategory: action.examCategory,
            };
        case ActionTypes.UPDATE_EXAM_WORD_TEST_CATEGORY: {
        ...
        case ActionTypes.EXAM_WORD_TEST_CATEGORY_ADD_DELETE: {
            var arrDelete = [];
            var deletes = [];
        ...
        case ActionTypes.DELETE_EXAM_WORD_TEST_CATEGORY:
            return {
                ...state,
                ids: [],
                checkAll: false,
            };
        case ActionTypes.EXAM_WORD_TEST_CATEGORY_CHECK_ALL: {
        ...
        case ActionTypes.DATA_REMOVE_EXAM_WORD_TEST_CATEGORY:
            return {
                ...state,
